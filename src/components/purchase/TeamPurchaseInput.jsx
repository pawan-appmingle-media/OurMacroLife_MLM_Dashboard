...
const TeamPurchaseInput = ({ levelNum, showButton = true }) => {
    ...
    <>
      <div className="relative flex p-1">
        ...
        <div className="relative">
          ...
          />
          <span className="font-bold absolute right-3 top-2 text-lg">%</span>
        </div>
        {showButton && (
          <button
      ...
      {showSuccess && (
        <p className="flex text-green-700 text-xs w-[85%] justify-end font-bold">
          Success
...
export default TeamPurchaseInput;
